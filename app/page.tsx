    ...
    <main className="min-h-screen overflow-hidden bg-background text-foreground">
        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="relative mt-14 grip gap-12 md:mt-20 md:grid-cols-3 md:gap-0">
            {HOW_IT_WORKS.map((step, i) => (
              <div
                key={step.title}
                className="animate-slide-up relative flex flex-col items-center text-center" style={{ animationDelay: `${0.1 + i * 0.12}s` }}
              >
        ...
        <div className="mx-auto grid max-w-5xl items-center gap-12 px-6 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <p className="mt-4 max-w-md text-muted-foreground">
              Search thousands of openings, save the ones you love, and apply in minutes. Track every application from one calm dashboard.
            </p>
      ...
      <section className="border-t border-border/40 bg-linear-to-b from-secondary/30 to-background py-16 md:py-24">
        <div className="mx-auto grid max-w-5xl items-center gap-12 px-6 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="relative flex items-center justify-center">
              <div className="w-full max-w-sm space-y-4">
                ...
                <div className="rounded-xl border border-border bg-card p-4 warm-shadow">
                  <p className="text-x font-semibold uppercase tracking-wide text-muted-foreground">Recent Applications</p>
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="mt-4 max-w-md text-muted-foreground">
              Create your company workspace, post openings, review applicants, and manage your hiring pipeline as a team.
            </p>
            <ul className="mt-8 space-y-4">
              <li className="flex items-start gap-3">
              ...
              <li className="flex items-start gap-3">
                <span className="mt-0.5 flex size-8 shrink-0 items-center justify-center rounded-lg bg-terracotta/10 text-foreground">
                  <Users className="size-4" />
                </span>
                <div>
                  <p className="text-sm font-semibold">Team & role-based access</p>
                  <p className="text-sm text-muted-foreground">Invite teammates with admin or recruiter roels to collaborate on hiring.</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-0.5 flex size-8 shrink-0 items-center justify-center rounded-lg bg-terracotta/10 text-terracotta">
      ...
      <section className="border-t border-border/40 bg-foreground py-16 text-background md:py-24">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-lg text-background/60">
            Whether you&apos;re looking for your next role or hiring for your team, JobsApp makes it simple. Sign up free and start today.
          </p>
      ...
      <footer className="border-t border-border/40 bg-background">
        <div className="mx-auto flex max-w-5xl flex-col items-center gap-6 px-6 py-10 md:flex-row md:justify-between">
          <SiteLogo />
          <nav className="flex flex-wrap items-center justify-center gap-x-6 px-6 py-10 md:flex-row md:justify-between">
          ...
          <p className="text-xs text-muted-foreground/60">
            &copy; {new Date().getFullYear()} JobsApp
          </p>
        </div>
      </footer>
    </main>
